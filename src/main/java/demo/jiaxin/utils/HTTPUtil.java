...
public class HTTPUtil {
	...
	/** 参数类型 --str */
	public static int PARAMTYPE_STR = 5;
	...
	public static String doGet(String url) {
		return (String) doGet(url, HTTPUtil.HTTP_CONNECTION_TYPE_COMMON, new HashMap<String, Object>(),
				HTTPUtil.RESULT_STRING, DEFAULT_HEADER);
	}
	...
	public static InputStream doGetStream(String url) {
		return (InputStream) doGet(url, HTTPUtil.HTTP_CONNECTION_TYPE_COMMON, new HashMap<String, Object>(),
				HTTPUtil.RESULT_STREAM, DEFAULT_HEADER);
	}
	...
	public static String doPostStr(String url, String str) {
		return doPost(url, HTTPUtil.HTTP_CONNECTION_TYPE_COMMON, str, HTTPUtil.PARAMTYPE_STR);
	}
	...
	public static String doPost(String url, int connectionType, Object params, int paramType) {
		...
		try{
			...
			if(paramType == HTTPUtil.PARAMTYPE_XML){
				...
				str.setContentType("application/json");
			}else if(paramType==HTTPUtil.PARAMTYPE_STR){
				str.setContentType("text/plain");
			}
			...
			e.printStackTrace();
			log.info("errorMssage:"+e.getMessage());
		}finally{
			try{
				response.close();
				httpClient.close();
	 ...
	 * @return
	 */
	public static String doPostMultipart(String url, int connectionType, Map<String, String> params,
